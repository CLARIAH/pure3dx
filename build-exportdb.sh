...
docker tag pure3d_exportdb:${dockertag} registry.huc.knaw.nl/pure3d/pure3d_exportdb:${dockertag}
docker tag pure3d_exportdb:${dockertag} registry.huc.knaw.nl/pure3d/pure3d_exportdb:latest
docker images | grep registry.huc.knaw.nl/pure3d/pure3d_exportdb:${dockertag}
docker push registry.huc.knaw.nl/pure3d/pure3d_exportdb:${dockertag}
docker push registry.huc.knaw.nl/pure3d/pure3d_exportdb:latest
